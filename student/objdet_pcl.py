...
def show_range_image(frame, lidar_name):
    ...
    ri_intensity = ri[:,:,1]
    ri_intensity_01 = np.percentile(ri_intensity, 1)
    ri_intensity_99 = np.percentile(ri_intensity, 99)
    ri_intensity = ri_intensity_99/2 * ri_intensity * 255 / (ri_intensity_99 - ri_intensity_99)
...
def bev_from_pcl(lidar_pcl, configs, cnt_frame):
    ...
    #print(lidar_pcl_cpy[:, 0], lidar_pcl_cpy[:, 1], lidar_pcl_cpy[:, 2])

    # step 4 : visualize point-cloud using the function show_pcl from a previous task
    show_pcl(lidar_pcl_cpy, cnt_frame)
    ...
    #print("lidar_pcl_int = ", lidar_pcl_int, "\n lidar_pcl_int[0] = ", lidar_pcl_int[0], "\n lidar_pcl_int[0][0] = ", lidar_pcl_int[0][0])
    counts = lidar_pcl_int[0]
