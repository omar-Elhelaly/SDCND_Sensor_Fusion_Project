...
class Trackmanagement:
    ...
    def manage_tracks(self, unassigned_tracks, unassigned_meas, meas_list):
        ...
        for T in self.track_list:
            if T.state == 'confirmed' and T.score < params.delete_threshold:
                self.delete_track(T)
            elif T.P[0, 0] > params.max_P or T.P[1, 1] > params.max_P or T.score < 1.0/params.window:
                self.delete_track(T)
    ...
    def handle_updated_track(self, track):
        ...
        if track.score + 1.0/params.window <= 1.0:
            track.score += 1.0/params.window
        else:
            track.score = 1.0
