...
def measure_detection_performance(detections, labels, labels_valid, min_iou=0.5):
    ...
    for label, valid in zip(labels, labels_valid):
        ...
        if valid: # exclude all labels from statistics which are not considered valid
            ...
            label_corners = tools.compute_box_corners(x,y,w,l,yaw)
            #print(label_corners)
            ...
            for detection in detections:
                ...
                id, bev_x, bev_y, bev_z, bev_h, bev_w, bev_l, bev_yaw = detection
                detection_corners = tools.compute_box_corners(bev_x, bev_y, bev_w, bev_l, bev_yaw)
    ...
    #print("labels_valid = ", labels_valid, "\n labels_valid.sum() = ", labels_valid.sum())
...
def compute_performance_stats(det_performance_all):
    ...
    total_positives, total_true_positives, total_false_negatives, total_false_positives = np.array(pos_negs).sum(axis=0)
